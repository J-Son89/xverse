...
export async function fetchOrdinalUtxos(address) {
  try {
...
export async function fetchInscriptionDetails(address, inscriptionId) {
  try {
...
export async function fetchInscriptionContent(inscriptionId) {
  try {
