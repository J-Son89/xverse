...
export const HomePage = () => {
  ...
  const queryKey = useMemo(
    () => ['ordinalUtxos', address, offset.current],
    [address, offset]
  );
...

        {
          <div className={styles.paginationButtons}>
            ...
            <Button
              ...
              disabled={
                !address ||
                (offset.current === 0 && !inscriptions) ||
                (total !== null && offset.current + LIMIT >= total) ||
                (Array.isArray(inscriptions) && inscriptions.length < LIMIT)
              }
              buttonType="secondary"
